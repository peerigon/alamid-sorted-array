...
function sortedArray(arr, comparator) {
    ...
    _.comparator = comparator || defaultComparator;
    _.reversed = false;
...
function indexOf(element) {
    /* jshint validthis:true */
    var index = binarySearch(this, element, this._sortedArray.comparator);
...
function reverse() {
    ...
    if (reversed) {
        _.comparator = _.comparator.original;
    } else {
        _.comparator = getInversionOf(_.comparator);
    }
    _.reversed = !reversed;
...
function findIndexFor(element) {
    /* jshint validthis:true */
    var index = binarySearch(toArray(this), element, this._sortedArray.comparator);
